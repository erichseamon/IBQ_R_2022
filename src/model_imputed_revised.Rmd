...
kable(round(all_combined_final, 3)) %>%
...
kable(round(trans_combined_final, 3)) %>%
kable_styling("striped", full_width = F,
                position = "left", font_size = 12) %>%
...
R2plot_all <- ggplot(R2_long[c(1:11, 23:33),],            
               aes(x = modelname,
                   y = value, 
                   color = variable, group = variable)) +  geom_line() + theme_bw() + ylim(0,.75) +
scale_color_manual(values=c('lightgreen','darkgreen'))+theme(text=element_text(size=18))+ labs(color = "Legend")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+labs(y= "R2 Value", x = "Model Type", title="R2 Chronological Age Model Comparisons", subtitle="Transformed vs All")
R2plot_all
...
AUCplot_all <- ggplot(AUC_long[c(1:11, 23:33),],            
               aes(x = modelname,
                   y = value, 
                   color = variable, group = variable)) +  geom_line() + theme_bw() + ylim(0,.75) +
scale_color_manual(values=c('lightgreen','darkgreen'))+theme(text=element_text(size=18))+ labs(color = "Legend")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+labs(y= "AUC Value", x = "Model Type", title="AUC Chronological Age Model Comparisons", subtitle="Transformed vs All")
AUCplot_all
...
R2plot_trans <- ggplot(R2_long[c(12:22, 34:44),],            
               aes(x = modelname,
                   y = value, 
                   color = variable, group = variable)) +  geom_line() + theme_bw() + ylim(0,.75) +
scale_color_manual(values=c('lightblue','darkblue'))+theme(text=element_text(size=18))+ labs(color = "Legend")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+labs(y= "R2 Value", x = "Model Type", title="R2 Adjusted Age Model Comparisons", subtitle="Transformed vs All")
R2plot_trans
...
AUCplot_trans <- ggplot(AUC_long[c(12:22, 34:44),],            
               aes(x = modelname,
                   y = value, 
                   color = variable, group = variable)) +  geom_line() + theme_bw() + ylim(0,.75) +
scale_color_manual(values=c('lightblue','darkblue'))+theme(text=element_text(size=18))+ labs(color = "Legend")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+labs(y= "AUC Value", x = "Model Type", title="AUC Adjusted Age Model Comparisons", subtitle="Transformed vs All")
AUCplot_trans
...
R2plot <- ggplot(R2_long,            
               aes(x = modelname,
                   y = value, 
                   color = variable, group = variable)) +  geom_line() + theme_bw() + ylim(0,.75) +
scale_color_manual(values=c('lightgreen','darkgreen','lightblue','darkblue'))+theme(text=element_text(size=18))+ labs(color = "Legend")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+labs(y= "R2 Value", x = "Model Type", title="R2 All Model Comparisons", subtitle="Transformed vs All")
R2plot
...
AUCplot <- ggplot(AUC_long,            
               aes(x = modelname,
                   y = value, 
                   color = variable, group = variable)) +  geom_line() + theme_bw() + ylim(0,.75) +
scale_color_manual(values=c('lightgreen','darkgreen','lightblue','darkblue'))+theme(text=element_text(size=18))+ labs(color = "Legend")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+labs(y= "AUC Value", x = "Model Type", title="AUC All Model Comparisons", subtitle="Transformed vs All")
AUCplot
