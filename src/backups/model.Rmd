...
p1 <- varImp(fit_rf_control_one_trans)$importance
p1$name <- rownames(p1)
p2 <- varImp(fit_rf_control_two_trans)$importance
p2$name <- rownames(p2)
...
p1 <- varImp(fit_rf_control_one_all)$importance
p1$name <- rownames(p1)
p2 <- varImp(fit_rf_control_two_all)$importance
p2$name <- rownames(p1)
