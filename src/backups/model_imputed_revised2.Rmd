---
title: "IBQ Machine Learning Supplemental 2023"
...
This supplemental appendix provides machine learning analyses figures and tables in support of the following paper: "", submitted to XXXX.
...
<!-- Figure S1: Accuracy Estimates: Chronological Age vs. Pre-Term - All Variables -->
<!-- <br></br> -->

<!-- Figure S2: Receiver Operator Curve: Chronological Age vs. Pre-Term - All Variables -->
<!-- <br></br> -->

<!-- Figure S3: Accuracy Estimates: Age Adjusted vs. Pre-Term - All Variables -->
<!-- <br></br> -->

<!-- Figure S4: Receiver Operator Curve: Age Adjusted vs. Pre-Term - All Variables -->

<!-- ### Transformed Feature Models -->

<!-- Figure S5: Accuracy Estimates: Chronological Age vs. Pre-Term - Transformed Variables -->
<!-- <br></br> -->

<!-- Figure S6: Receiver Operator Curve: Chronological Age vs. Pre-Term - Transformed Variables -->
<!-- <br></br> -->

<!-- Figure S7: Accuracy Estimates: Age Adjusted vs. Pre-Term - Transformed Variables -->
<!-- <br></br> -->

<!-- Figure S8: Receiver Operator Curve: Age Adjusted vs. Pre-Term - Transformed Variables -->

<!-- ### Feature Importance Graphs -->

<!-- Figure S9: Feature Importance: Chronological Age vs. Pre-Term - All Variables -->
<!-- <br></br> -->

<!-- Figure S10: Feature Importance: Age Adjusted vs. Pre-Term - All Variables -->
<!-- <br></br> -->

<!-- Figure S11: Feature Importance: Chronological Age vs. Pre-Term - Transformed Variables -->
<!-- <br></br> -->

<!-- Figure S12: Feature Importance: Age Adjusted vs. Pre-Term - Transformed Variables -->
...
<!-- Figure S13: R2 Comparisons - Chronological Age VS Pre-Term, Transformed Variables VS. All Variables -->
<!-- <br></br> -->

<!-- Figure S14: AUC Comparisons - Chronological Age VS Pre-Term, Transformed Variables VS. All Variables -->
<!-- <br></br> -->

<!-- Figure S15: R2 Comparisons - Age Adjusted VS Pre-Term, Transformed Variables VS. All Variables -->
<!-- <br></br> -->

<!-- Figure S16: AUC Comparisons - Age Adjusted VS Pre-Term, Transformed Variables VS. All Variables -->
...
p1$name <- c("Positive Affectivity", "Negative Affectivity", "Effortful Control")
# p1name <- gsub("^.*?_","",p1$name)
# p1name <- gsub("^.*?_","",p1name)
p1$category <- p1$name
# 
p2$name <- c("Positive Affectivity", "Negative Affectivity", "Effortful Control")
...
levels(p1$category) <- c("Positive Affectivity", "Negative Affectivity", "Effortful Control" )

p2name <- gsub("^.*?_","",p2$name)
p2name <- gsub("^.*?_","",p2name)
p2$category <- as.factor(p2name)
levels(p2$category) <- c("Positive Affectivity", "Negative Affectivity", "Effortful Control" )
...
kable_styling("striped", full_width = F,
                position = "left", font_size = 12) %>%
  add_header_above(c("models" = 1, "Chronological VS. Pre-Term: Transformed" = 3, "Adjusted Age VS. Pre-Term: Transformed" = 3))
...
scale_color_manual(values=c('lightgreen','darkgreen'))+theme(text=element_text(size=36))+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size=24))+labs(y= "R2 Value", x = "Model Type")+ theme(legend.position="bottom", legend.box="vertical") + guides(color = guide_legend(nrow = 2)) + 
...
AUCplot_all <- ggplot(AUC_long[c(1:11, 23:33),],            
               aes(x = modelname,
                   y = value, group = Legend)) +  geom_line(aes(linetype=Legend, color=Legend), lwd=1.75) + theme_bw() + ylim(.2,.75) +
scale_color_manual(values=c('lightgreen','darkgreen'))+theme(text=element_text(size=36))+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size=24))+labs(y= "AUC Value", x = "Model Type")+ theme(legend.position="bottom", legend.box="vertical") + guides(color = guide_legend(nrow = 2)) + 
    theme(legend.key.width = unit(5, "line"))
AUCplot_all
...
R2plot_trans <- ggplot(R2_long[c(12:22, 34:44),],            
               aes(x = modelname,
                   y = value, group = Legend)) +  geom_line(aes(linetype=Legend, color=Legend), lwd=1.75) + theme_bw() + ylim(.2,.75) +
scale_color_manual(values=c('lightblue','darkblue'))+theme(text=element_text(size=36))+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size=24))+labs(y= "R2 Value", x = "Model Type")+ theme(legend.position="bottom", legend.box="vertical") + guides(color = guide_legend(nrow = 2)) + theme(legend.key.width = unit(5, "line"))
R2plot_trans
...
AUCplot_trans <- ggplot(AUC_long[c(12:22, 34:44),],            
               aes(x = modelname,
                   y = value, group = Legend)) +  geom_line(aes(linetype=Legend, color=Legend), lwd=1.75) + theme_bw() + ylim(.2,.75) +
scale_color_manual(values=c('lightblue','darkblue'))+theme(text=element_text(size=36))+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size=24), legend.position="bottom", legend.box="vertical")+labs(y= "AUC Value", x = "Model Type") + guides(color = guide_legend(nrow = 2)) + theme(legend.key.width = unit(5, "line"))
AUCplot_trans
