...
```{r, echo=FALSE, warning = FALSE, message = FALSE, error=FALSE, fig.width = 10.5, fig.height = 7.5, fig.cap=paste("Receiver Operator Curve: Chronological Age Group vs. Pre-Term Group - Itemized Variables.")}
...
```{r, echo=FALSE, warning = FALSE, message = FALSE, error=FALSE, fig.width = 10.5, fig.height = 7.5, fig.cap=paste("Accuracy Estimates: Age Adjusted Group vs. Pre-Term Group - Itemized Variables.")}
set.seed(9999)
library(haven)
library(klaR)
#Infant gender model construction
...
```{r, echo=FALSE, warning = FALSE, message = FALSE, error=FALSE, fig.width = 10.5, fig.height = 7.5, fig.cap=paste("Receiver Operator Curve: Age Adjusted Group vs. Pre-Term Group - Itemized Variables.")}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 10.5, fig.height = 7.5, fig.cap=paste("Feature Importance: Age Adjusted Group vs. Pre-Term Group - Itemized Variables")}
...
colnames(R2) <- c("Chronological Age Group, Itemized Variables", "Age Adjusted Group, Itemized Variables", "Chronological Age Group, Transformed Variables", "Age Adjusted Group, Transformed Variables", "modelname")
...
colnames(AUC) <- c("Chronological Age Group, Itemized Variables", "Age Adjusted Group, Itemized Variables", "Chronological Age Group, Transformed Variables", "Age Adjusted Group, Transformed Variables", "modelname")
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap=paste("R2 Comparisons - Chronological Age Group VS Pre-Term Group, Transformed Variables VS. Itemized Variables.")}
library(kableExtra)
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap=paste("AUC Comparisons - Chronological Age Group VS Pre-Term Group, Transformed Variables VS. Itemized Variables.")}
library(kableExtra)
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap=paste("R2 Comparisons - Age Adjusted Group VS Pre-Term Group, Transformed Variables VS. Itemized Variables.")}
library(kableExtra)
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap=paste("AUC Comparisons - Age Adjusted Group VS Pre-Term Group, Transformed Variables VS. Itemized Variables.")}
library(kableExtra)
